          ...
          {project.technologies && project.technologies.length > 0 && (
            <div className="flex flex-wrap justify-center gap-1.5 mt-4">
              {project.technologies.map((tech) => (
                <span
                  key={tech}
                  className="px-3 py-1 rounded-full text-sm font-medium bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400"
                >
                  {tech}
                </span>
              ))}
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-4">
            {project.githubUrl && (
              <a
                ...
                rel="noreferrer"
                className={`group/btn inline-flex items-center gap-2.5 px-6 py-3 rounded-2xl text-sm font-semibold transition-all duration-300
              ...
              >
                ...
                Git repository
                {project.isGithubPrivate && (
                  <span className="text-sm opacity-80 font-medium ml-1">(privado)</span>
                )}
              </a>
            )}
            <a
            ...
            >
              ...
              Project URL
              {project.isSiteOff && (
                <span className="text-sm opacity-80 font-medium ml-1">(offline)</span>
              )}
            </a>
          </div>
        </div>
